<div class="container-fluid">
	...
	switch (@$_GET['mod']) {
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><img src="../img/<?= $data['gambar_kategori'] ?>" style='width: 100px; height:100px; object-fit:cover' alt=""></td>
		...
		case 'add': ?>
				<form method='POST' action='aksi_kategori.php?mod=tambah' class='form-horizontal' enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" required="required" name='nm_kategori' class="form-control" placeholder="Nama Kategori">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">Gambar</label>
						<div class="col-sm-4">
							<input type="file" required="required" name='gambar' class="form-control">
						</div>
					</div>
		...
		case 'edit':
			...
			?>
				<form method='POST' action='aksi_kategori.php?mod=edit' class='form-horizontal' enctype="multipart/form-data">
